    ...
    <section className="glass-card glass-border-glow p-5">
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <div>
          ...
          <p className="font-mono-data text-2xl font-black text-foreground">
            {(data.primary as { capital_deploy_pct?: string }).capital_deploy_pct ?? data.primary.capital_deploy_formatted}
          </p>
        </div>
      </div>
    </section>
